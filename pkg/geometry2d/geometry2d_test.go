...
func TestGeometry2D_GetClosestPointToSegment(t *testing.T) {}

func TestGeometry2D_GetDistanceToSegment(t *testing.T) {}

func TestGeometry2D_GetDistanceSquaredToSegment(t *testing.T) {}
