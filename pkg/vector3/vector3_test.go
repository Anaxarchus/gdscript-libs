...
func TestVector3_DotVector3(t *testing.T) {}

func TestVector3_Add(t *testing.T) {}

func TestVector3_Addf(t *testing.T) {}

func TestVector3_Sub(t *testing.T) {}

func TestVector3_Subf(t *testing.T) {}

func TestVector3_Mul(t *testing.T) {}

func TestVector3_Mulf(t *testing.T) {}

func TestVector3_Div(t *testing.T) {}

func TestVector3_Divf(t *testing.T) {}
...
func TestVector3_Sign(t *testing.T) {}
...
func TestVector3_CubicInterpolateInTime(t *testing.T) {}

func TestVector3_BezierInterpolate(t *testing.T) {}

func TestVector3_BezierDerivative(t *testing.T) {}

func TestVector3_DistanceTo(t *testing.T) {}

func TestVector3_DistanceSquaredTo(t *testing.T) {}

func TestVector3_Posmod(t *testing.T) {}

func TestVector3_Posmodv(t *testing.T) {}

func TestVector3_Project(t *testing.T) {}
...
func TestVector3_LengthSquared(t *testing.T) {}

func TestVector3_Normalize(t *testing.T) {}

func TestVector3_Normalized(t *testing.T) {}

func TestVector3_IsNormalized(t *testing.T) {}

func TestVector3_IsEqualApprox(t *testing.T) {}
