...
func TestVector2_Addf(t *testing.T) {}

func TestVector2_Subf(t *testing.T) {}

func TestVector2_Mulf(t *testing.T) {}

func TestVector2_Divf(t *testing.T) {}
...
func TestVector2_IsNormalized(t *testing.T) {}

func TestVector2_DistanceTo(t *testing.T) {}

func TestVector2_DistanceSquaredTo(t *testing.T) {}

func TestVector2_DirectionTo(t *testing.T) {}
...
func TestVector2_Clampf(t *testing.T) {}

func TestVector2_Snapped(t *testing.T) {}

func TestVector2_Snappedf(t *testing.T) {}

func TestVector2_LimitLength(t *testing.T) {}

func TestVector2_MoveToward(t *testing.T) {}
